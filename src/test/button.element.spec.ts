...
import '$lib/ui/button/button.element'
...
describe('Button element', async () => {
  ...
  it('should be in none mode', async () => {
    ...
    expect(el.className).toContain(
      'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors transition-duration: 0.05s focus:outline-none focus:ring-2 focus:ring-ring h-9 px-4 py-2'
    )
  })
