...
export class CheckboxElement extends TailwindMixin(LitElement) {
  ...
  render() {
    return html`
      <div class=${this.elementClass} @click=${this.handleClick}>
        ...
        <div class="relative inline-block pl-[0.5em] top-[1px] whitespace-nowrap overflow-hidden text-ellipsis">
          <slot></slot>
        </div>
      </div>
    `
